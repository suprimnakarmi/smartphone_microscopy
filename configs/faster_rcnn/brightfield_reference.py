...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=os.path.join(
                data_root, "fold_1", "brightfield_reference_coco_annos_train.json"
            ),
    ...
    val=dict(
        ...
        classes=classes,
        ann_file=os.path.join(
            data_root, "fold_1", "brightfield_reference_coco_annos_val.json"
        ),
        img_prefix=os.path.join(data_root, "train"),
...
work_dir = f"/mnt/Enterprise/safal/AI_assisted_microscopy_system/outputs/{sample_type}/faster_rcnn/fold_1"
