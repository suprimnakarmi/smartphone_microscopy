...
_base_ = "../../mmdetection/configs/deformable_detr/deformable_detr_r50_16x2_50e_coco.py"
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=os.path.join(
                data_root, "fold_5", "brightfield_reference_coco_annos_train.json"
            ),
    ...
    val=dict(
        ...
        classes=classes,
        ann_file=os.path.join(
            data_root, "fold_5", "brightfield_reference_coco_annos_val.json"
        ),
        img_prefix=os.path.join(data_root, "train"),
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                group=f"deformable_detr_{sample_type}",
                name=f"{sample_type}_deformable_detr_fold_5",
            ),
        ),
    ],
)
